...
mlb <- mlb %>% mutate(capacity = as.numeric(capacity), attend_tot = as.numeric(attend_tot), attend_avg = as.numeric(attend_avg), games = as.numeric(games), ticket_price = as.numeric(ticket_price), home_wins = as.numeric(home_wins))
